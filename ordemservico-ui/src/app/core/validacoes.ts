...
/* Estah classe não esta sendo usada no projeto
   porque ela so funciona com Reactive Forms porem ao tentar salvar
   um cpf invalido o backend vi validar o cpf e não irá passar ateh
   que ele seja digitado corretamente.
*/
export class Validacoes {

    static ValidaCpf(controle: any) {
